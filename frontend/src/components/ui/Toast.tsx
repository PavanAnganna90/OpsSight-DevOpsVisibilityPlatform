...
import { useToast as useToastFromContext, ToastProvider as ContextToastProvider } from "@/contexts/ToastContext"

// Radix Toast Provider (for Radix UI components)
...
export { useToastFromContext as useToast }
// Export the context ToastProvider (not Radix) for app-wide use
export { ContextToastProvider as ToastProvider }
