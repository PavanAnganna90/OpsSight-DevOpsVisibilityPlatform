    ...
    >
      ...
      <body className={isStaticGeneration ? 'h-full bg-gray-50 dark:bg-gray-900' : `${inter.className} h-full bg-gray-50 dark:bg-gray-900`}>
        {isStaticGeneration ? (
          ...
          // Full layout with all providers for runtime
          ErrorBoundary && ProvidersWrapper && LoadingBoundary ? (
            <ErrorBoundary>
              <ProvidersWrapper>
                <LoadingBoundary>
                  <div className="min-h-screen flex flex-col">
                    ...
                    {/* Navigation */}
                    {ClientOnlyNavigation && <ClientOnlyNavigation />}
                    ...
                    {ClientOnlyCommandPalette && <ClientOnlyCommandPalette />}
                  </div>
                </LoadingBoundary>
              </ProvidersWrapper>
            </ErrorBoundary>
          ) : (
            // Fallback if components aren't loaded yet
            <div className="min-h-screen flex flex-col">
              <main 
                id="main-content"
                role="main"
